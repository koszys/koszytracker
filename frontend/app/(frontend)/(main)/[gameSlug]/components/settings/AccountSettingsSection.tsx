...
export default function AccountSettingsSection({ terms, servers }: AccountSettingsSectionProps) {
    const { activeAccount, updateActiveAccount } = useSettings();

    if (!terms.ar && !terms.wl && !terms.mcTitle) return null;
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                if (isNaN(val)) val = '';
                                else if (val > (terms.maxAr ?? 99)) val = terms.maxAr ?? 99;
                                else if (val < 1) val = 1;
